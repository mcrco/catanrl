                    ...
                    wandb.log(
                        {
                            ...
                            "train/return_variance": metrics["return_variance"],
                            "train/return_std": metrics["return_std"],
                            "train/value_prediction_mean": metrics["value_prediction_mean"],
                            "train/value_prediction_std": metrics["value_prediction_std"],
                            "train/value_mse": metrics["value_mse"],
                            "train/value_normalized_mse": metrics["value_normalized_mse"],
                            "train/value_explained_variance": metrics["value_explained_variance"],
